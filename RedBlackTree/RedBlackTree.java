...
public class RedBlackTree {
    ...
    private static final class Node {
        ...
        public Node left;
        public Node right;
        public boolean color;//se falso é vermelho, se true é black
        public Node(Integer element) {
            father = null;
            left = null;
            right = null;
            color = false; //false = vermelho, true = black
    ...
    private Node nil; //Node nill (SENTINELA)
    ...
    public String getColor(Integer element){
    ...
    private Node add(Node n, Integer e, Node father) { // método auxiliar
        if (n == null) {
            Node aux = new Node(e);
            aux.father = father;
            aux.left = nil;
